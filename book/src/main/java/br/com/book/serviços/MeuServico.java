...
public class MeuServico {
    ...
    public Entidade criarLivro(Entidade livro) {
        try{
            ...
            return null; //Retorna null porde ser uma maneira simples de indicar que ocorreu um erro e não foi possível retornar o valor desejado.
        }
    }
    ...
    public Optional<Entidade> buscarLivroPorId(long id) {
        try{
            ...
            return Optional.empty(); //Quando é retornado um Optional vazio é útil em situações que um método espera um Optional, mas ele não tem valor para retornar e indica que nenhum valor foi encontrado.
        }
    }
